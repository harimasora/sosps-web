...
(function () {
    ...
    angular.module('BlurAdmin.pages.charts.amCharts')
      .controller('PSAdultoLineChartCtrl', PSAdultoLineChartCtrl);

    /** @ngInject */
    function PSAdultoLineChartCtrl($scope, baConfig, layoutPaths, $firebaseArray) {
        ...
        var lineChart = AmCharts.makeChart('PSAdultoLineChart', {
            type: 'serial',
            theme: 'blur',
        ...
        $scope.render = function() {
            ...
            var currentObj = $scope.watingTimeHistory.$getRecord($scope.selected.hospitalId).PSAdulto;
